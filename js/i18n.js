const T = {
  en: {
    ...
    mapPanel: { title: 'Prediction Map', distribution: 'Hornbill Distribution', rainfallMap: 'Rainfall Map', temperatureMap: 'Temperature Map', dustMap: 'PM2.5 Map', rasterNotLoaded: 'This raster hasn’t loaded yet — upload a .tif in Environmental Layers, or wait for the default to finish loading.',
      forestRiskTitle: 'Forest Cover × Bird Risk', riskRainfall: 'Rainfall risk', riskTemperature: 'Temperature risk', riskDust: 'Dust risk', riskLow: 'Low', riskHigh: 'High' },
  ...
  th: {
    ...
    mapPanel: { title: 'แผนที่ผลการทำนาย', distribution: 'การกระจายพันธุ์นกเงือก', rainfallMap: 'แผนที่ปริมาณฝน', temperatureMap: 'แผนที่อุณหภูมิ', dustMap: 'แผนที่ฝุ่น PM2.5', rasterNotLoaded: 'ยังไม่ได้โหลดราสเตอร์นี้ — อัปโหลดไฟล์ .tif ที่การ์ดชั้นข้อมูลสิ่งแวดล้อม หรือรอให้ค่าเริ่มต้นโหลดเสร็จ',
      forestRiskTitle: 'พื้นที่ป่าไม้ × ความเสี่ยงของนก', riskRainfall: 'ความเสี่ยงจากฝน', riskTemperature: 'ความเสี่ยงจากอุณหภูมิ', riskDust: 'ความเสี่ยงจากฝุ่น', riskLow: 'ต่ำ', riskHigh: 'สูง' },
    ...
    map: { basemap: 'แผนที่ฐาน', realNote: 'แผนที่ฐาน OpenStreetMap จริง และข้อมูลจุดพบนกจริงจาก GBIF', rasterNote: 'ข้อมูลจริงจาก TMD Climate Atlas (พ.ศ. 2534-2563) แทรกค่าจากสถานีตรวจอากาศ — ดูที่ rnd.tmd.go.th/climateatlas', dustNote: 'ค่าเฉลี่ยฝุ่น PM2.5 รายภาค พ.ศ. 2557-2567 (แบ่ง 6 ภาค) — เป็นแผนที่แบบโซนหยาบ ไม่ใช่พื้นผิวที่แทรกค่าละเอียด ทุกจุดในภาคเดียวกันจะแสดงค่าเฉลี่ยของภาคนั้นเหมือนกันหมด',
