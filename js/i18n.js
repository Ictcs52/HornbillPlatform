const T = {
  en: {
    ...
    mapPanel: { title: 'Prediction Map', distribution: 'Hornbill Distribution', rainfallMap: 'Rainfall Map', temperatureMap: 'Temperature Map', low: 'Low', high: 'High', denseForest: 'Dense / primary forest', secondaryForest: 'Secondary / mixed forest', rasterNotLoaded: 'This raster hasn’t loaded yet — upload a .tif in Environmental Layers, or wait for the default to finish loading.' },
  ...
  th: {
    ...
    mapPanel: { title: 'แผนที่ผลการทำนาย', distribution: 'การกระจายพันธุ์นกเงือก', rainfallMap: 'แผนที่ปริมาณฝน', temperatureMap: 'แผนที่อุณหภูมิ', low: 'ต่ำ', high: 'สูง', denseForest: 'ป่าดิบชื้น (หนาแน่น)', secondaryForest: 'ป่าเบญจพรรณ/รอง', rasterNotLoaded: 'ยังไม่ได้โหลดราสเตอร์นี้ — อัปโหลดไฟล์ .tif ที่การ์ดชั้นข้อมูลสิ่งแวดล้อม หรือรอให้ค่าเริ่มต้นโหลดเสร็จ' },
