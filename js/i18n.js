const T = {
  en: {
    ...
    mapPanel: { forestRiskTitle: 'Forest Cover × Bird Risk', riskRainfall: 'Rainfall risk', riskTemperature: 'Temperature risk', riskDust: 'Dust risk', riskLow: 'Low', riskHigh: 'High' },
    ...
    map: {
      forestRiskNoteFit: 'Real forest cover as the basemap. Points are colored by that single variable’s predicted suitability drop from the fitted model (other variables held at their current value) — not the combined risk shown elsewhere.',
      forestRiskNoteNotFit: 'Real forest cover as the basemap, occurrence points in species colors. Click Run to color points by each variable’s individual predicted risk instead.' },
  ...
  th: {
    ...
    mapPanel: { forestRiskTitle: 'พื้นที่ป่าไม้ × ความเสี่ยงของนก', riskRainfall: 'ความเสี่ยงจากฝน', riskTemperature: 'ความเสี่ยงจากอุณหภูมิ', riskDust: 'ความเสี่ยงจากฝุ่น', riskLow: 'ต่ำ', riskHigh: 'สูง' },
    ...
    map: {
      forestRiskNoteFit: 'พื้นที่ป่าไม้จริงเป็นแผนที่ฐาน จุดจะเปลี่ยนสีตามความเสี่ยงที่ทำนายได้จากตัวแปรนั้นตัวเดียว (ตรึงตัวแปรอื่นไว้ที่ค่าปัจจุบัน) — ไม่ใช่ความเสี่ยงรวมที่แสดงในที่อื่น',
      forestRiskNoteNotFit: 'พื้นที่ป่าไม้จริงเป็นแผนที่ฐาน จุดพบยังเป็นสีตามชนิดนก กด Run เพื่อให้จุดเปลี่ยนสีตามความเสี่ยงของแต่ละตัวแปร' },
